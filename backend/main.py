...
# 1. On définit la configuration D'ABORD
cloudinary_config = {
...
# 2. On l'applique ENSUITE (si les clés existent)
if cloudinary_config["cloud_name"] and cloudinary_config["api_key"]:
    cloudinary.config(**cloudinary_config)
    print("✅ Configuration Cloudinary chargée.")
else:
...
async def upload_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Erreur lors de l'upload vers Cloudinary")
